...
import kg.core.R
import kotlinx.android.synthetic.main.view_mark_image_button.view.*

class MarkImageButton(context: Context, attributeSet: AttributeSet) :
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.view_mark_image_button, this, true)
        ...
        context.theme.obtainStyledAttributes(attributeSet, R.styleable.MarkImageButton, 0, 0)
            .apply {
                try {
                    ...
                    /*getInt(R.styleable.RoundedSelectView, 0).takeIf { it > 0 }?.let {
